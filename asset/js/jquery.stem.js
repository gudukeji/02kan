	...
	fixed: function(){
		...
		$(window).scroll(function(){
			...
			if (targetTop >= 50){
				...
				$("#topnav,.listnow,.art_navlist").addClass("nav_fixed nav_top");
				$("#bfqxl,.listnow,.art_navlist").addClass("xiala");
				$("#gensui,.listnow,.art_navlist").addClass("gensui");
			}else{
				$("#topnav,.listnow,.art_navlist").removeClass("nav_fixed nav_top");
				$("#topnav,.listnow,.art_navlist").removeClass("nav_fixed nav_top");
				$("#bfqxl,.listnow,.art_navlist").removeClass("xiala");
				$("#gensui,.listnow,.art_navlist").removeClass("gensui");
			}
		});
		$(window).scroll(function(){
			var $this = $(this);
 ...
 //           var cmd2 = url2 + "?source=" + app_key + "&url_long=" + shareurl + encodeURIComponent(ikan.browser.urlpath);
	...
	//	var zans_jjtc = $("#zans_jjtc").val();
		...
		$(".btn_zhans").click(function() {
            $("body").append('<div class="hl_wrap"><div class="mac_pop_bg"></div><div class="hl_content"><div class="hl_content_hd"><h4 class="hl_content_title">' + zans_title + '</h4></div><div class="hl_content_bd"><img class="info_img" src="' + zans_qrcode + '" alt="赞赏二维码"><p>' + zans_text + '</div><div class="hl_content_ft"><a class="hl_btn_no" href="javascript:;">残忍拒绝</a><a class="close_box" href="javascript:;">取消</a></div></div></div>')
